...
{
	public class PropellerLogic : PropulsionLogic
	{
		public float m_fuelFlow = 0.0f;

		public PropellerLogic(GameObject parentObj = null)
		{
			m_attributes["MaxThrust"] = 246000.0f;
			m_attributes.Add("SpecificImpulse", 4000.0f);
